...
include './auth.php';
mysqli_query($dbhandle,"INSERT INTO `lodge_db`.`guest` 
...
");
$id = mysqli_insert_id();
mysqli_query($dbhandle,"INSERT INTO `lodge_db`.`booking` (`booking_id`, `room_id`, `totalroombook`, `guest_id`, `total_adult`, `total_children`, `checkin_date`, `checkout_date`, `special_requirement`, `payment_status`, `total_amount`, `deposit`, `booking_date`) 
