	...
	<div class="large-8 columns blackblur fontcolor" style="padding:10px">
		...
		<div class="large-12 columns" >
			<?php
				...
				$result = mysqli_query($dbhandle,"SELECT r.room_id, (r.total_room-b.totalroombook) as availableroom from room as r LEFT JOIN ( 
					...
					while ($row = mysqli_fetch_array($result)) {
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysqli_num_rows($sub_result) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : ZMW </span><span style=\"font-size:24px;\">".$sub_row['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
							...
							if(mysqli_num_rows($sub_result2) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : ZMW </span><span style=\"font-size:24px;\">".$sub_row2['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
