...
<div class="row">
		...
		<p><b>Your Reservation</b></p><hr class="line">
				...
				<div class="row">					
						<div class="large-12 columns" style="max-width:100%;">
							...
							<span class="fontslabo " style="font-size:32px; text-align:center;">ZMW <?php echo $_SESSION['deposit'];?></span>
							<br><span class="fontgrey" style="text-align:center;">Total</span><br>
							<span class="fontslabo" style="font-size:32px; text-align:center;">ZMW <?php echo $_SESSION['total_amount'];?></span></p>
	...
	<div class="large-8 columns blackblur fontcolor" style="padding:10px">
		...
		<p>
		<i class="icon-phone" style="font-size:24px"></i> <span class="i-name fontgrey">Phone</span><span class="i-code">&emsp; 0973122312</span><br>
        <i class="icon-fax" style="font-size:24px"></i> <span class="i-name fontgrey">Fax</span><span class="i-code"> &emsp;&emsp;0973122312</span><br>
