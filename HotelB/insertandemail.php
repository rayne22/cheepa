...
$message .="															<td  style=\"width:200px;\"> <b>ZMW".$_SESSION['ind_rate'][$count]."</b></td>\n";
$message .="														</tr>\n";
$count = $count+1;
} ;
...
$message .="															<td  style=\"width:200px;\"> <b>ZMW".$_SESSION['total_amount']."</b></td>\n";
$message .="														</tr>\n";
$message .="														<tr>\n";
$message .="															<td style=\"width:200px;\">15% Deposit Due</td>\n";
$message .="															<td  style=\"width:200px;\"><b>ZMW".$_SESSION['deposit']."</b></td>\n";
$message .="														</tr>\n";;
$message .="														\n";
$message .="													</table>\n";
...
$message .="					<input type=\"hidden\" name=\"currency_code\" value=\"ZMW\">\n";
